    ...
    return (
        <div className='container'>
            ...
            <div className='divbutton'>
                <Link to={`/Connexion`}>
                    <Button variant="outlined" size="large" sx={{ width: 300, backgroundColor: '#5E8CFF', color: 'black', borderRadius: '20px', '&:hover': {backgroundColor: '#111B2E', color: 'white',},}}>Connexion</Button>
                </Link>
                <Link to={`/Inscription`}>
                    <Button variant="outlined" size="large" sx={{ width: 300, backgroundColor: '#5E8CFF', color: 'black', borderRadius: '20px', marginLeft: '20px', '&:hover': {backgroundColor: '#111B2E', color: 'white',},}}>Inscription</Button>
                </Link>
            </div>
